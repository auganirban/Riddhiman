...
%for y = 0.05:0.01:0.07
     for x = 0.72:0.01:0.820
         ...
         %   theta2 = 0;
            ...
            e = 1;      % Error in orientation between current pose and guiding pose on imitated trajectory
            ...
            while ef(k-1) > position_tol || mf(k-1) > orientation_tol
                ...
                [S(:,k),joint_angles(:,k),g_final(:,:,k),q1(k,:)] = redundancy_res(g1(:,:,k),S(:,k-1),joint_angles(:,k-1)); %NC01
                ...
                % Compute interpolted path between current configuration and imitated
