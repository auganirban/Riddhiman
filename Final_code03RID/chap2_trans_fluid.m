...
%load('R4.mat','theta');
load('fluid_move.mat','fluid_theta');
...
[theta1, g_st1, DualQuaternion1] = denoising(fluid_theta);
...
%             -0.2108    0.9743    0.0787     0.1052;
%             -0.0673    0.0659   -0.9954     0.45;-0.0591
%                 0         0         0      1.0000];
            temp21 = [ -0.3757   -0.4413    0.8146    0.7211;
                       -0.5743    0.8009    0.1690    0.2998;
                       -0.7271   -0.4043   -0.5544   -0.0591;
                            0         0         0    1.0000];
...
%                        0            0          0     1.000];
            ...
            while ef(k-1) > position_tol || mf(k-1) > orientation_tol
                ...
                [J_st,S(:,k),joint_angles(:,k),g_final(:,:,k),q1(k,:)] = redundancy_res_with_JLA(g1(:,:,k),S(:,k-1),joint_angles(:,k-1),orient_init,k); %NC01
